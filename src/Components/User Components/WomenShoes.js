...
const WomenShoes = (props) => {
    ...
    const { products, womenItems, casualWomen, formalWomen, ethnicWomen, addCart, sizeFunc, elemIdFunc, addOrder, getUser, userinfo, setContactFunc, setAddressFunc } = context;
